...
import UniverityU.UniverityUFactory;
import UniverityU.UniverityUPackage;
import UniverityU.University;

import UniverityU.uncertainty.UncertaintyPackage;

import UniverityU.uncertainty.impl.UncertaintyPackageImpl;
 ...
 * @generated
 */
public class UniverityUPackageImpl extends EPackageImpl implements UniverityUPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see UniverityU.UniverityUPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private UniverityUPackageImpl() {
		super(eNS_URI, UniverityUFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link UniverityUPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static UniverityUPackage init() {
		if (isInited) return (UniverityUPackage)EPackage.Registry.INSTANCE.getEPackage(UniverityUPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredUniverityUPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		UniverityUPackageImpl theUniverityUPackage = registeredUniverityUPackage instanceof UniverityUPackageImpl ? (UniverityUPackageImpl)registeredUniverityUPackage : new UniverityUPackageImpl();
		...
		theUniverityUPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(UniverityUPackage.eNS_URI, theUniverityUPackage);
		return theUniverityUPackage;
	}
	 ...
	 */
	@Override
	public UniverityUFactory getUniverityUFactory() {
		return (UniverityUFactory)getEFactoryInstance();
	}
