 ...
 * @generated
 */
public class UniverityUSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UniverityUPackage.COURSES: {
				Courses courses = (Courses)theEObject;
				T result = caseCourses(courses);
				if (result == null) result = caseModelElement(courses);
				if (result == null) result = caseaCourses(courses);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniverityUPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = caseModelElement(person);
				if (result == null) result = caseaPerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UniverityUPackage.UNIVERSITY: {
				University university = (University)theEObject;
				T result = caseUniversity(university);
				if (result == null) result = caseModelElement(university);
				if (result == null) result = caseaUniversity(university);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
