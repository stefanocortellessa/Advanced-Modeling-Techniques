 ...
 * </p>
 * <ul>
 *   <li>{@link UniverityU.uncertainty.impl.uPersonImpl#getName <em>Name</em>}</li>
 *   <li>{@link UniverityU.uncertainty.impl.uPersonImpl#getUtype <em>Utype</em>}</li>
 *   <li>{@link UniverityU.uncertainty.impl.uPersonImpl#getUleft <em>Uleft</em>}</li>
 *   <li>{@link UniverityU.uncertainty.impl.uPersonImpl#getUright <em>Uright</em>}</li>
 *   <li>{@link UniverityU.uncertainty.impl.uPersonImpl#getUpoint <em>Upoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class uPersonImpl extends aPersonImpl implements uPerson {
	 ...
	 * @ordered
	 */
	protected EList<aPerson> uright;
	 ...
	 */
	@Override
	public EList<aPerson> getUleft() {
		if (uleft == null) {
			uleft = new EObjectContainmentEList<aPerson>(aPerson.class, this, UncertaintyPackage.UPERSON__ULEFT);
		}
		return uleft;
	}
	 ...
	 */
	@Override
	public EList<aPerson> getUright() {
		if (uright == null) {
			uright = new EObjectContainmentEList<aPerson>(aPerson.class, this, UncertaintyPackage.UPERSON__URIGHT);
		}
		return uright;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UncertaintyPackage.UPERSON__ULEFT:
				getUleft().clear();
				getUleft().addAll((Collection<? extends aPerson>)newValue);
				return;
			case UncertaintyPackage.UPERSON__URIGHT:
				getUright().clear();
				getUright().addAll((Collection<? extends aPerson>)newValue);
				return;
			case UncertaintyPackage.UPERSON__UPOINT:
				getUpoint().clear();
