 ...
 * </p>
 * <ul>
 *   <li>{@link UniverityU.uncertainty.impl.uCoursesImpl#getName <em>Name</em>}</li>
 *   <li>{@link UniverityU.uncertainty.impl.uCoursesImpl#getUtype <em>Utype</em>}</li>
 *   <li>{@link UniverityU.uncertainty.impl.uCoursesImpl#getUleft <em>Uleft</em>}</li>
 *   <li>{@link UniverityU.uncertainty.impl.uCoursesImpl#getUright <em>Uright</em>}</li>
 *   <li>{@link UniverityU.uncertainty.impl.uCoursesImpl#getUpoint <em>Upoint</em>}</li>
 * </ul>
 *
 * @generated
 */
public class uCoursesImpl extends aCoursesImpl implements uCourses {
	 ...
	 * @ordered
	 */
	protected EList<aCourses> uleft;
	 ...
	 * @ordered
	 */
	protected EList<aCourses> uright;
	 ...
	 */
	@Override
	public EList<aCourses> getUleft() {
		if (uleft == null) {
			uleft = new EObjectContainmentEList<aCourses>(aCourses.class, this, UncertaintyPackage.UCOURSES__ULEFT);
		}
		return uleft;
	}
	 ...
	 */
	@Override
	public EList<aCourses> getUright() {
		if (uright == null) {
			uright = new EObjectContainmentEList<aCourses>(aCourses.class, this, UncertaintyPackage.UCOURSES__URIGHT);
		}
		return uright;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case UncertaintyPackage.UCOURSES__ULEFT:
				getUleft().clear();
				getUleft().addAll((Collection<? extends aCourses>)newValue);
				return;
			case UncertaintyPackage.UCOURSES__URIGHT:
				getUright().clear();
				getUright().addAll((Collection<? extends aCourses>)newValue);
				return;
			case UncertaintyPackage.UCOURSES__UPOINT:
				getUpoint().clear();
