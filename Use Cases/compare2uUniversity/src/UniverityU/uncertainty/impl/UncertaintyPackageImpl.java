...
import UniverityU.uncertainty.uCourses;
import UniverityU.uncertainty.uPerson;
...
public class UncertaintyPackageImpl extends EPackageImpl implements UncertaintyPackage {
	 ...
	 * @see UniverityU.uncertainty.UncertaintyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static UncertaintyPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(UniverityUPackage.eNS_URI);
		UniverityUPackageImpl theUniverityUPackage = (UniverityUPackageImpl)(registeredPackage instanceof UniverityUPackageImpl ? registeredPackage : UniverityUPackage.eINSTANCE);

		// Create package meta-data objects
		theUncertaintyPackage.createPackageContents();
		theUniverityUPackage.createPackageContents();

		// Initialize created meta-data
		theUncertaintyPackage.initializePackageContents();
		theUniverityUPackage.initializePackageContents();
	...
	public void initializePackageContents() {
		...
		initEReference(getuCourses_Uleft(), this.getaCourses(), null, "uleft", null, 0, -1, uCourses.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getuCourses_Uright(), this.getaCourses(), null, "uright", null, 0, -1, uCourses.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getuPerson_Uleft(), this.getaPerson(), null, "uleft", null, 0, -1, uPerson.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getuPerson_Uright(), this.getaPerson(), null, "uright", null, 0, -1, uPerson.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getuUniversity_Uleft(), this.getaUniversity(), null, "uleft", null, 0, -1, uUniversity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getuUniversity_Uright(), this.getaUniversity(), null, "uright", null, 0, -1, uUniversity.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
